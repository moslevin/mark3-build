...
if [ "${FORMAT}" = "console" ]; then
    ...
    echo    "in mark3cfg.h and portcfg.h at compile time.  Note that these sizes "
    echo    "represent the echo maximum size of each module before dead code "
    echo    "elimination and any additional link-time optimization, and represent "
    echo    "the maximum possible size that any module can take."
    echo    ""
